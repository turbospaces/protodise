...
public class MessagePackStreamBenchmark {
    public static void main(String... args) throws InterruptedException {
        final MessagePackStream stream = new MessagePackStream( AbstractStreamsTest.registry );
                ...
                public void run() {
                    try {
                        for ( int j = 0; j < iterations; j++ ) {
                            ExposedByteArrayOutputStream baos = new ExposedByteArrayOutputStream( 256 );
